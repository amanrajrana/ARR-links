 ...
 * @param data - The parameter `data` is an object that contains shortId`
 *  These properties are used to generate two short URLs that will be displayed on the
...
const displayShortUrl = (data) => {
  ...
  shortUrlSpan.innerText = data.shortUrl;
...
const displayQrError = (error) => {
  ...
  document
    .getElementsByClassName("qr-code-container")[0]
